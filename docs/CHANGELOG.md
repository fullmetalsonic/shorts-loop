...
## 0.5.1/code35 · 설치용 APK / Installable APK
...
준비 소스91791f2 Public 게시 완료, CI33218554151 SUCCESS. 로컬705JUnit·debug lint·다국어·민감정보 검사 및 비로그인 기존3개 배포파일 동일성 PASS. / Source-only publication and CI succeed; the existing stable download remains unchanged.
